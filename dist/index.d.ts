...
export declare enum PatternDetected {
    NO = 0,
    YES = 1
}
export declare enum Pattern {
    ...
    TRIPLE_BOTTOM = 0,
    TRIPLE_TOP = 1,
    UPTREND_RISING_WEDGE = 0,
    UPTREND_FALLING_WEDGE = 1,
    DOWNTREND_RISING_WEDGE = 0,
    DOWNTREND_FALLING_WEDGE = 1
}
export declare enum StockEventType {
    SUBSCRIBE = "sub",
    UNSUBSCRIBE = "unsub"
}
export declare enum StockTicker {
    RRRP3_SA = "RRRP3.SA",
    ALPA4_SA = "ALPA4.SA",
    ABEV3_SA = "ABEV3.SA",
    AMER3_SA = "AMER3.SA",
...
export declare enum MarketHoursType {
    PRE_MARKET = 0,
    REGULAR_MARKET = 1,
    POST_MARKET = 2,
